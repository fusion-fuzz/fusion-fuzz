...
| ![MLIR](https://img.shields.io/badge/MLIR-supported-brightgreen?logo=llvm&logoColor=white) | **In Development** | Official nightly build; driver and parser functional |
| ![Rust](https://img.shields.io/badge/Rust-in%20development-blue?logo=rust&logoColor=white) | **Supported** | Driver and parser functional; may have edge-case bugs |
