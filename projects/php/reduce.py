...
if __name__ == "__main__":
    ...
    # default php path
    phppath = "/home/fuzz/WorkSpace/fusion-fuzz/projects/php/php-src/sapi/cli/php"
    ...
    reduced_config = f'/home/fuzz/WorkSpace/fusion-fuzz/projects/php/php-src/sapi/cli/php {reduced_config} ./test.php'

    # auto generate bug report
    report_template = "\nThe following code:\n\n```php\n{poc}\n```\n\nResulted in this output:\n```\n{stdouterr}\n```\n\nTo reproduce:\n```\n{config}\n```\n\nCommit:\n```\n{commit}\n```\n\nConfigurations:\n```\n{php_config}\n```\n\nOperating System:\n```\n{os}\n```\n\n*This bug was found by [fusion-fuzz](https://github.com/fusion-fuzz/fusion-fuzz)*\n"

    os.system("cd /home/fuzz/WorkSpace/fusion-fuzz/projects/php/php-src/; git rev-parse origin/master > /tmp/php_commit")
